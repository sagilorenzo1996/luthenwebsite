  ...
  return (
    <section style={{ maxWidth: 780, margin: '0 auto', padding: '80px 40px' }}>
      ...
      {[
        ...
        { heading: '5. GDPR & Data Transfers', body: 'For customers in the European Economic Area, Luthen acts as a data processor. We offer Standard Contractual Clauses and support data residency requirements. Contact support@behaviol.com for a Data Processing Agreement.' },
        { heading: '6. Contact Us', body: 'If you have questions about this policy, email support@behaviol.com or write to Luthen, Inc., Unit 105 29-31, Lexington Drive, Bella Vista NSW 2153.' },
      ].map(section => (
